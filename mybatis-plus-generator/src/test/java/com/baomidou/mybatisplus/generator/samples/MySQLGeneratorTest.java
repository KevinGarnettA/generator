...
public class MySQLGeneratorTest extends BaseGeneratorTest {
    ...
    private static final DataSourceConfig DATA_SOURCE_CONFIG = new DataSourceConfig
        .Builder("jdbc:mysql://192.168.33.24:3307/mos_safety_control?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai", "root", "123456")
//        .Builder("jdbc:mysql://192.168.33.116:3306/mos_dispatch?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai", "root", "123qwe")
    ...
    public void testSimple() {
        ...
        generator.strategy(strategyConfig().addInclude("safety_control_water_record").
